...
- Remove "Map of Skyrim" from the plugin's "Misc. Item" data along with "FormID List".startingitems and under "Misc.Item".TRC_MapStorageCase, Weapon.TRC_WorldMap, Quest.TRC_MapQuest set '110C0BBC' records to 0, and under Quest.TRC_MaintenanceQuest remove the '110C0BBC' record using xEdit to completely remove the broken map from the mod.
