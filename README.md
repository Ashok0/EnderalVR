...
11.  Close MO2.  Navigate to your \DynDOLOD\ folder from Step 5 and move the \TexGen_Output\ folder to C:\Users\ (Username)\AppData\Local\ModOrganizer\Skyrim VR\mods.  Launch MO2 and enable TexGen_Output in the left window pane.
